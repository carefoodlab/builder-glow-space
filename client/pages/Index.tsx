...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-orange-50/30 to-white">
          ...
          <div className="space-y-12 md:space-y-20">
            ...
            <div className="group flex flex-col lg:flex-row items-center gap-8 lg:gap-[70px] transform transition-all duration-700 hover:scale-[1.02]">
              <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                ...
                <div className="absolute top-4 left-4 w-12 h-12 bg-health-orange rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
                  1
                </div>
              </div>
              <div className="flex-1 text-center lg:text-left">
                <div className="mb-4">
                  <span className="inline-block w-12 h-1 bg-gradient-to-r from-health-orange to-orange-400 rounded-full"></span>
                </div>
                <h3 className="font-pretendard text-health-gray text-[24px] md:text-[32px] lg:text-[40px] font-bold leading-[140%] mb-4 group-hover:text-health-orange transition-colors duration-300">
                  건강검진 데이터 입력
                </h3>
      ...
      <section className="py-16 md:py-24 lg:py-[120px] px-4 md:px-8 lg:px-20 bg-gradient-to-br from-orange-50/30 via-white to-orange-50/30 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-72 h-72 bg-health-orange/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl"></div>
        <div className="container mx-auto max-w-[1280px] relative z-10">
          <div className="mb-12 md:mb-16 text-center">
            <div className="inline-block px-6 py-2 bg-green-100 rounded-full mb-6">
              <span className="font-pretendard text-green-600 text-sm font-semibold">
                고객 만족도 98%
              </span>
            </div>
            <h2 className="font-pretendard text-health-gray text-[28px] md:text-[40px] lg:text-[50px] font-bold leading-[130%]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Review 1 */}
            <div className="group p-8 md:p-10 bg-white/80 backdrop-blur-sm border border-white/20 rounded-3xl shadow-xl hover:shadow-2xl transform transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
              <div className="flex items-center gap-4 mb-7">
                <div className="w-12 h-12 bg-gradient-to-br from-health-orange to-orange-400 rounded-full flex items-center justify-center shadow-lg transform transition-all duration-300 group-hover:scale-110">
              ...
              <p className="font-pretendard text-health-gray/80 text-base font-normal leading-[150%] relative">
                <span className="text-health-orange text-4xl font-bold absolute -top-2 -left-2">
                  "
                </span>
                예전에는 하루 세끼 뭘 먹어야 할지 늘 고민이었어요. 그런데 제
                식습관과 취향에 맞춰서 매일 식단을 추천해주니까, 지금은 그냥
                알려주는 대로 따라�� 해도 되니까 너무 편해요. 식재료도 흔한
                것들이고, 요리법도 간단해서 바쁠 때도 부담이 없어요!
                <span className="text-health-orange text-4xl font-bold">"</span>
              </p>
            </div>
            ...
            <div className="group p-8 md:p-10 bg-white/80 backdrop-blur-sm border border-white/20 rounded-3xl shadow-xl hover:shadow-2xl transform transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
              <div className="flex items-center gap-4 mb-7">
                <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-400 rounded-full flex items-center justify-center shadow-lg transform transition-all duration-300 group-hover:scale-110">
                  <span className="text-lg">🧘‍♀️</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-pretendard text-health-gray text-xl font-bold">
              ...
              <p className="font-pretendard text-health-gray/80 text-base font-normal leading-[150%] relative">
                <span className="text-green-500 text-4xl font-bold absolute -top-2 -left-2">
                  "
                </span>
            ...
            <div className="group p-8 md:p-10 bg-white/80 backdrop-blur-sm border border-white/20 rounded-3xl shadow-xl hover:shadow-2xl transform transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
              <div className="flex items-center gap-4 mb-7">
                <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-full flex items-center justify-center shadow-lg transform transition-all duration-300 group-hover:scale-110">
              ...
              <p className="font-pretendard text-health-gray/80 text-base font-normal leading-[150%] relative">
                <span className="text-blue-500 text-4xl font-bold absolute -top-2 -left-2">
                  "
                </span>
            ...
            <div className="group p-8 md:p-10 bg-white/80 backdrop-blur-sm border border-white/20 rounded-3xl shadow-xl hover:shadow-2xl transform transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
              <div className="flex items-center gap-4 mb-7">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-400 rounded-full flex items-center justify-center shadow-lg transform transition-all duration-300 group-hover:scale-110">
                  <span className="text-lg">👵</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-pretendard text-health-gray text-xl font-bold">
              ...
              <p className="font-pretendard text-health-gray/80 text-base font-normal leading-[150%] relative">
                <span className="text-purple-500 text-4xl font-bold absolute -top-2 -left-2">
                  "
                </span>
      ...
      {/* FAQ Section */}
      <section className="py-16 md:py-24 lg:py-[120px] px-4 md:px-8 lg:px-20 bg-gradient-to-br from-slate-50 via-white to-slate-50">
        <div className="container mx-auto max-w-[1280px]">
          <div className="mb-12 md:mb-16 text-center">
            <div className="inline-block px-6 py-2 bg-blue-100 rounded-full mb-6">
              <span className="font-pretendard text-blue-600 text-sm font-semibold">
                자주 묻는 질문
              </span>
            </div>
            <h2 className="font-pretendard text-health-gray text-[28px] md:text-[40px] lg:text-[50px] font-bold leading-[130%]">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-white/20">
            <Accordion type="multiple" className="space-y-6">
              <AccordionItem
                value="item-1"
                className="border border-gray-200 rounded-2xl p-6 hover:border-health-orange/30 transition-all duration-300 hover:shadow-lg"
              >
                <AccordionTrigger className="font-pretendard text-health-gray text-lg md:text-xl font-bold leading-[140%] text-left hover:no-underline hover:text-health-orange transition-colors duration-300">
                  Q. 어떤 건강 정보를 입력해야 하나요?
                </AccordionTrigger>
                <AccordionContent className="font-pretendard text-health-gray/80 text-lg md:text-xl font-normal leading-[140%] pt-6 border-t border-gray-100 mt-4">
              ...
              <AccordionItem
                value="item-2"
                className="border border-gray-200 rounded-2xl p-6 hover:border-blue-300 transition-all duration-300 hover:shadow-lg"
              >
                <AccordionTrigger className="font-pretendard text-health-gray text-lg md:text-xl font-bold leading-[140%] text-left hover:no-underline hover:text-blue-500 transition-colors duration-300">
              ...
              <AccordionItem
                value="item-3"
                className="border border-gray-200 rounded-2xl p-6 hover:border-green-300 transition-all duration-300 hover:shadow-lg"
              >
                <AccordionTrigger className="font-pretendard text-health-gray text-lg md:text-xl font-bold leading-[140%] text-left hover:no-underline hover:text-green-500 transition-colors duration-300">
              ...
              <AccordionItem
                value="item-4"
                className="border border-gray-200 rounded-2xl p-6 hover:border-purple-300 transition-all duration-300 hover:shadow-lg"
              >
                <AccordionTrigger className="font-pretendard text-health-gray text-lg md:text-xl font-bold leading-[140%] text-left hover:no-underline hover:text-purple-500 transition-colors duration-300">
                  Q. 비건/채식 식단도 지원하나요?
                </AccordionTrigger>
                <AccordionContent className="font-pretendard text-health-gray/80 text-lg md:text-xl font-normal leading-[140%] pt-6 border-t border-gray-100 mt-4">
                  A. 네! 사용자의 건강 상태에 맞춘 균형 잡힌 식단을 제공합니다.
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-8 lg:px-20 h-full flex flex-col justify-center">
          <div className="max-w-2xl">
            <div className="backdrop-blur-sm bg-white/10 rounded-3xl p-8 md:p-10 border border-white/20 shadow-2xl">
              <h2 className="font-pretendard text-white text-[28px] md:text-[40px] lg:text-[50px] font-bold leading-[130%] mb-8 md:mb-10 drop-shadow-lg">
                지금 시작해도 늦지 않았어요
                <br />
                <span className="text-yellow-300">건강하고 즐겁게</span>{" "}
                살기위한 첫 단계
              </h2>
              <Button className="group bg-gradient-to-r from-white to-gray-100 hover:from-gray-100 hover:to-white text-health-orange font-poppins font-semibold px-6 md:px-10 py-4 md:py-5 text-sm md:text-base rounded-[88px] h-auto transform transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-xl">
                <span className="flex items-center gap-2">
                  내 건강식단 찾아보기
                  <svg
                    className="w-4 h-4 transform transition-transform group-hover:translate-x-1"
