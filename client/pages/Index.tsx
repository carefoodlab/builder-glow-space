...
export default function Index() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section
        className="relative w-full h-[660px] bg-cover bg-center"
        style={{
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-20 h-full flex flex-col justify-center">
          <div className="max-w-2xl">
            <h1 className="font-pretendard text-white text-[50px] font-bold leading-[130%] mb-6">
              간단 데이터를 나에게 딱 맞는
              <br />
              건강한 한 끼를 추천해요
            </h1>
            <Button className="bg-health-orange hover:bg-health-orange/90 text-black font-poppins font-semibold px-10 py-5 text-base rounded-[88px] h-auto">
              건강 식단 추천받기
            </Button>
          </div>
        </div>
      ...
      <section className="py-[120px] px-20">
        <div className="container mx-auto max-w-[1280px]">
          <div className="mb-16">
            <h2 className="font-pretendard text-health-gray text-[50px] font-bold leading-[130%]">
              나의 건강상태를 분석해서
              <br />
              개인 맞춤형 식단을 제공해요
            </h2>
          ...
          <div className="space-y-16">
            ...
            <div className="flex items-center gap-[70px]">
              <img
                ...
                alt="건강검진 데이터 입력"
                className="w-[570px] h-[390px] object-cover"
              />
              <div className="flex-1">
                <h3 className="font-pretendard text-health-gray text-[40px] font-bold leading-[140%] mb-4">
                  건강검진 데이터 입력
                </h3>
                <p className="font-pretendard text-health-gray text-xl font-normal leading-[140%]">
      ...
      <section className="py-[120px] px-20 bg-white">
        <div className="container mx-auto max-w-[1280px]">
          <div className="mb-16">
            <h2 className="font-pretendard text-health-gray text-[50px] font-bold leading-[130%]">
              많은 분들이 간편하고
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-20 h-full flex flex-col justify-center">
          <div className="max-w-2xl">
            <h2 className="font-pretendard text-health-orange text-[50px] font-bold leading-[130%] mb-10">
              지금 시작해도 늦지 않았어요
              <br />
              건강하고 즐겁게 살기위한 첫 단계
            </h2>
